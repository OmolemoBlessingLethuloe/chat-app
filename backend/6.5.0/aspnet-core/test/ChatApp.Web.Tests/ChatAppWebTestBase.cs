...
using ChatApp.Models.TokenAuth;
...
{
    public abstract class ChatAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ChatAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ChatAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ChatAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ChatAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ChatAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ChatAppDbContext, Task<T>> func)
        {
            T result;
